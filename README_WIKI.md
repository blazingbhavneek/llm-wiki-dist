...
このイメージには、`llm-wiki-rikiseisan` のWebアプリケーションとバックエンドサーバーが含まれています。
...
```text
Host: 10.160.152.38
Path: /home/seigyo/docker-images/llm-wiki-rikiseisan.tar.gz
```

イメージをコピーしてロードします:

```bash
scp seigyo@10.160.152.38:/home/seigyo/docker-images/llm-wiki-rikiseisan.tar.gz .
docker load -i llm-wiki-rikiseisan.tar.gz
```
