...
const STR = {
  ja: {
    ...
    types: {
      ...
      sync_raw: 'raw/ から GROWI へ同期',
      sync_growi: 'GROWI からインデックスを同期',
  ...
  en: {
    ...
    stages: {
      ...
      publish: 'Publishing to GROWI',
      growi_sync: 'Syncing from GROWI',
    ...
    types: {
      ...
      sync_raw: 'Sync raw/ to GROWI',
      sync_growi: 'Sync index from GROWI',
